...
public class Notifications_Getjson {
    //    public static Bitmap[] bitmaps;
    public static String[] Android_date_time;
    ...
    public Notifications_Getjson(String json) {
        this.json = json;
        try {
    ...
    public void getAllImages() throws JSONException {
        Android_date_time = new String[urls.length()];
...
//        bitmaps = new Bitmap[urls.length()];
        ...
        for (int i = 0; i < urls.length(); i++) {
            Android_date_time[i] = urls.getJSONObject(i).getString(date_time);
